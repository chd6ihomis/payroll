            ...
            <div class="table">
                    ...
                    <tr>
                        ...
                        <td class="text-left" style="width:400px">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">No: 02-102101-{{ now()->format('Y')}}</li>
                ...
                <table class="table">
                    ...
                    <tbody>
                            ...
                            <td class="text-center">
                                <ul class="list-group list-group-flush">
                                    @forelse($salaries->sortBy('fund_source') as $office)
										@if(substr($office->fund_source, 0, 5) == 'CONAP')
										<li class="list-group-item"> {{ substr($office->fund_source,6,18) }}</li>
										@else
                        ...
                        @if($salaries->sum('comm_allowance') > 0)
                        <tr>
                            <td class="text-center">

                            </td>
                            <td class="text-center" style="width:150px">
                                <p> Telephone Expenses - Mobile </p>
                            </td>
                            <td class="text-center" style="width:150px">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">310300300007000 CA </li>
                                </ul>
                            </td>
                            <td class="text-center" style="width:150px">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">5020502001</li>
                                </ul>
                            </td>
                            <td class="text-center" style="width:150px">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">{{ number_format($salaries->sum('comm_allowance'),2)}}</li>
                                </ul>
                            </td>
                        </tr>
                        @endif
                        <tr class="total">
                            ...
                            <th class="text-center">{{ number_format($salaries->sum('total') + $salaries->sum('comm_allowance'),2) }}</th>
                        </tr>
                    </tbody>
